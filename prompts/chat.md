...
- context_chunks: the most relevant document excerpts selected by lexical retrieval
...
3. `citations`: 1–3 exact verbatim quotes from the provided context chunks that support the answer. Do not invent or complete quotations.
