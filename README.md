...
- `guardrail.md` — reference classifier prompt; deployed analysis routes share a lightweight server-side screen that blocks clearly non-legal files but allows uncertain documents to proceed with caution
